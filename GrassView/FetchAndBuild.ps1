...
elseif ($Theme -eq 'Yellow') { $cBG='13,17,23,240'; $cL0='33,38,46,255'; $cL1='70,60,0,255';   $cL2='155,135,0,255';  $cL3='220,195,0,255';  $cL4='255,240,0,255'   }
elseif ($Theme -eq 'Cyan')   { $cBG='13,17,23,240'; $cL0='33,38,46,255'; $cL1='0,45,70,255';   $cL2='0,110,160,255';  $cL3='0,195,235,255';  $cL4='60,235,255,255'  }
